<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:img_surface  Version:1.2.5.0 - Mon May 10 20:25:05 UTC 2021 -->
  ...
  <sch:pattern>
    <sch:rule context="img_surface:Geometry_Projection/img_surface:geometry_projection_type">
      <sch:assert test=". = ('Linearized', 'Raw', 'Trapezoid')">
        ...
        The attribute img_surface:geometry_projection_type must be equal to one of the following values 'Linearized', 'Raw', 'Trapezoid'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
